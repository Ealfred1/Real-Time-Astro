...
const SectionB = () => {
	return (
		<section className="my-9 bg-[url('/zodiac3.png')] bg-no-repeat bg-cover">
			<div className="bg-[rgba(50,50,50,0.4)] w-full h-full flex items-center justify-center flex-col w-full h-[20rem] py-12 gap-4">
