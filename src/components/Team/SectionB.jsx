...
const SectionB = () => {
	return (
		<section className="my-9 bg-[url('/zodiac4.png')] bg-no-repeat bg-cover w-full">
			<div className="bg-gradient-to-r from-[rgba(50,50,50,0.9)] to-tertiary w-full h-full flex items-center justify-center flex-col w-full h-[20rem] py-12 gap-4">
				...
				<h1 className="text-[4.1rem] tracking-tight uppercase text-center text-white whitespace-nowrap font-serif">join our community; Become a member</h1>
